...
map<double, int*> prediction_search (int nfs[]) {
    ...
    for (int i=12;i<12+NEW_SFC;i++) {
        ...
        nf_tmp.core = 0;
        sfcs[4].current = 12;
        sfcs[4].last = 12+NEW_SFC-1;
        sfcs[4].nfs[i-12] = nf_tmp; 
    } 
...
int main() {
    ...
    cout << "heuristic placement run time is : " << total_time_search << "us" << endl;
